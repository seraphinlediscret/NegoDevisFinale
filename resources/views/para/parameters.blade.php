...
@section('content')
  ...
  <!--//////////////WELCOME/////////////////////-->
  <div id="well">
    <h1 class="titbvn">Bienvenue sur Négodevis !</h1>
    <p id="bvn">Veuillez configurer vos paramètres pour entrer en négociation</p>
  </div>
...
<div id="containerparam" >
    ...
    <h2 id="parameters-title">Modifier vos Paramètres</h2>
